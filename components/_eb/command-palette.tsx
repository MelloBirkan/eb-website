...
const ITEMS: Item[] = [
  ...
  { id: 's-an', kind: 'skill', title: 'evenbetter-ios-analyze', section: 'Auditoria', href: '/tutorial/plugins/ios#auditoria' },
  { id: 's-vd', kind: 'skill', title: 'evenbetter-validate', section: 'Auditoria', href: '/tutorial/plugins/ios#auditoria' },
  { id: 's-fx', kind: 'skill', title: 'evenbetter-fix', section: 'Auditoria', href: '/tutorial/plugins/ios#auditoria' },
